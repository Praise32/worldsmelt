---
id: eng-spec-pools-rarity
title: Design di pool e rarita (fase 3b)
domain: engineering
status: superseded
authority: historical
owner: engineering
summary: >-
  Spec di pool/rarita a 4 livelli con tabelle pesi e tetti: implementata; i valori sono oggi i default proposti registrati da DEC-019 e docs/design/systems/items-pools-and-rarity.md.
