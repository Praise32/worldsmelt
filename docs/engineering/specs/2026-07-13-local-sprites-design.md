---
id: eng-spec-local-sprites
title: Design degli sprite locali (fase 2)
domain: engineering
status: implemented
authority: supporting
owner: engineering
summary: >-
  Spec della fase 2: melting-sprites su stable-diffusion.cpp, due eseguibili separati per i due ggml incompatibili, post-processing e controlli qualita.
