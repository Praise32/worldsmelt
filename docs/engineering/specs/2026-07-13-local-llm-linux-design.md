---
id: eng-spec-local-llm-linux
title: Design del ciclo build Linux + LLM locale (fase 1)
domain: engineering
status: implemented
authority: canonical
owner: engineering
summary: >-
  Spec della fase 1: build Linux, melting-gen come processo esterno llama.cpp/Vulkan con GBNF+validatore+fallback deterministico; la roadmap delle fasi vive qui.
