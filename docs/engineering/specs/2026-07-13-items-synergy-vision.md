---
id: eng-spec-items-synergy-vision
title: Vision oggetti e sinergie (fase 3)
domain: engineering
status: superseded
authority: historical
owner: engineering
summary: >-
  Vision doc della fase 3 (oggetti attivi/stat-up, personaggio a strati, sinergie): implementata e poi superata dai documenti KB systems (items, synergies) e dalle decisioni DEC-001..108.
