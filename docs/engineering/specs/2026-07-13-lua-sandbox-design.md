---
id: eng-spec-lua-sandbox
title: Design della sandbox Lua (fase 3a)
domain: engineering
status: implemented
authority: canonical
owner: engineering
summary: >-
  Spec di sicurezza della sandbox Lua 5.5: allowlist _ENV, tetto memoria, budget istruzioni, vie di fuga chiuse e limiti di determinismo; citata da AGENTS.md, test e codice.
