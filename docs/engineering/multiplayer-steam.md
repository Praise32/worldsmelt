---
id: eng-multiplayer-steam-direction
title: Multiplayer su Steamworks — direzione proposta
domain: engineering
status: proposed
...
[Multiplayer and Competition](../design/08-multiplayer-and-competition.md) e
[Run Manifest and Reproducibility](../design/systems/run-manifest-and-reproducibility.md))
...
- **Achievement**: candidati naturali per esporre le prove specifiche della run (`DEC-027`,
  `DEC-042`, vedi [Rewards and Economy](../design/systems/rewards-and-economy.md) e
  [Floor Zero](../design/systems/floor-zero.md)) come achievement Steam, oltre alla loro
...
- **Cloud save**: sincronizzazione del profilo persistente (catalogo, punti sblocco, vedi
  [Save and Meta Progression](../design/systems/save-and-meta-progression.md)) tra
...
- Non ridefinisce le regole di classifica, i criteri di normalizzazione della difficoltà per
  ...
  `../design/governance/open-questions.md`), né alcun altro comportamento di gioco.
