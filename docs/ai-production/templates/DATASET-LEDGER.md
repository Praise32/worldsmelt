---
id: aiprod-dataset-ledger
title: Dataset Ledger Specification
domain: ai-production
status: draft
authority: supporting
owner: ai-production
summary: >-
  Formato JSONL per il ledger dei dataset: provenance, licenza, split, caption, hash originale/processato; regole su provenance_status e split_group.
last_reviewed: 2026-07-22
topics: [template, dataset, licenze, provenance, JSONL]
related: []
supersedes: []
source_files: []
---
