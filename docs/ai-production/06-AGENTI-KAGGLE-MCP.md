---
id: aiprod-agenti-kaggle-mcp
title: Codex/Claude + Kaggle MCP
domain: ai-production
status: proposed
authority: supporting
owner: ai-production
summary: >-
  Architettura e configurazione per collegare Codex CLI/Claude Code a Kaggle via MCP o CLI fallback, policy di autorizzazione GPU e flusso settimanale.
last_reviewed: 2026-07-22
topics: [kaggle-mcp, agenti, codex, claude-code, policy-gpu]
related: []
supersedes: []
