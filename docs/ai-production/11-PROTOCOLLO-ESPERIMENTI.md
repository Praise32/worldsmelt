...
owner: ai-production
summary: >-
  Metodologia per esperimenti LoRA: una domanda per run, massimo due variabili, baseline obbligatoria, metriche automatiche, review umana e regola di promozione.
last_reviewed: 2026-07-22
topics: [esperimenti, metodologia, metriche, promozione, id-esperimento]
related: []
supersedes: []
source_files: []
---
