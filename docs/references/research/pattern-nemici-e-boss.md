---
id: ref-pattern-nemici-e-boss
title: Pattern di nemici e boss (per la fase 3b)
domain: references
status: approved
authority: supporting
owner: design
summary: >-
  Catalogo di 8 pattern di comportamento nemico e il sistema boss a parti, mappati su on_enemy_update/spawn_enemy/MonsterPart, con piano di adozione incrementale in 6 passi per la fase 3b, non ancora avviata.
last_reviewed: 2026-07-22
last_verified_commit: fe27f6d
topics: [pattern-nemici, boss-a-parti, on-enemy-update, spawn-enemy, part-system, isaac-reference]
related: []
supersedes: []
source_files: []
---
