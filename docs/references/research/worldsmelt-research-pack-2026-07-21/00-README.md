---
id: ref-pack-readme
title: Worldsmelt — dossier tecnico e strategico
domain: references
status: proposed
authority: supporting
owner: design
summary: >-
  Indice del pacchetto di ricerca 21/07: tesi centrale (LLM locale scrive Lua sandboxato per meccaniche), 8 decisioni consolidate, elenco file analizzati e fonti.
last_reviewed: 2026-07-22
topics: [research-pack, indice, lua-sandboxato, modello-unico, architettura]
related: []
supersedes: []
source_files: []
---
