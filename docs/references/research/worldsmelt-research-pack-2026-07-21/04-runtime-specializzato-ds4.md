---
id: ref-pack-runtime-specializzato-ds4
title: Runtime di inferenza specializzato — lezione di DS4
domain: references
status: proposed
authority: supporting
owner: design
summary: >-
  Analizza antirez/ds4 (runtime MoE specializzato); conclude che non e' direttamente applicabile a Worldsmelt (modello denso 4-7B) e propone strategia a 4 livelli su llama.cpp.
last_reviewed: 2026-07-22
topics: [ds4, runtime-inferenza, llama-cpp, quantizzazione, moe, strategia-runtime]
related: []
supersedes: []
source_files: []
---
