---
id: ref-pack-stato-repository-e-architettura
title: Stato della repository e architettura
domain: references
status: proposed
authority: supporting
owner: design
summary: >-
  Audit dell'architettura reale: benchmark LLM/immagini gia' misurati, separazione processi esterni, sandbox Lua, API attuale, gap del 'test del laser'.
last_reviewed: 2026-07-22
topics: [audit-architettura, sandbox-lua, benchmark, generative-gameplay-kernel, gap-primitive]
related: []
supersedes: []
source_files: []
---
