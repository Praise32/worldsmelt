---
id: ref-pack-sicurezza-e-generazione-meccaniche
title: Sicurezza e kernel di generazione delle meccaniche
domain: references
status: proposed
authority: supporting
owner: design
summary: >-
  Propone architettura command-queue, primitive query/azioni/visualizzazione/stato, budget, pipeline di accettazione a 11 fasi, eventi per sinergie e piano fuzzing/CI.
last_reviewed: 2026-07-22
topics: [sicurezza-lua, command-queue, primitive-gameplay, sinergie-eventi, determinismo, fuzzing]
related: []
supersedes: []
source_files: []
---
