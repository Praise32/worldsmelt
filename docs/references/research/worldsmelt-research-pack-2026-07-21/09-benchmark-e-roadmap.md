---
id: ref-pack-benchmark-e-roadmap
title: Benchmark e roadmap proposta
domain: references
status: proposed
authority: supporting
owner: design
summary: >-
  Roadmap in 8 fasi (A-H) da congelamento tesi tecnica a decisione su runtime proprietario, con criterio di release finale per una build candidata.
last_reviewed: 2026-07-22
topics: [roadmap, benchmark, fasi-sviluppo, criterio-release, steam-deck]
related: []
supersedes: []
source_files: []
---
