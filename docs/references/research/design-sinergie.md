---
id: ref-design-sinergie
title: Design delle sinergie implicite (il prossimo passo)
domain: references
status: approved
authority: supporting
owner: design
summary: >-
  Appunto tecnico che mappa il modello di sinergie implicite di Isaac (stats cache + tear flags) sul motore Melting Run e propone l'Opzione 1 (tavola C) come prima versione; e' la spec da cui e' stato costruito src/gameplay/synergies.c.
last_reviewed: 2026-07-22
last_verified_commit: fe27f6d
topics: [sinergie, stats-cache, tear-flags, item-archetype, rarity-scaling, isaac-reference]
related: []
supersedes: []
source_files: []
---
